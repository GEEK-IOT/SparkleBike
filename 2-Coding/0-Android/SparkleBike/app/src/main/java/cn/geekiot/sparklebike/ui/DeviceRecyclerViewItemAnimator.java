...
/**
 * Created by oppo on 2016/10/20.
 */

public class DeviceRecyclerViewItemAnimator extends SimpleItemAnimator {
    ...
    private void animateRemoveImpl(final RecyclerView.ViewHolder holder) {
        ...
        animation.setDuration(getRemoveDuration())
                .alpha(0).translationX(-50).setListener(new VpaListenerAdapter() {
            @Override
    ...
    public boolean animateAdd(final RecyclerView.ViewHolder holder) {
        ...
        ViewCompat.setTranslationX(holder.itemView, 50);
